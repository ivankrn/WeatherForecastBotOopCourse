...
public interface WeatherForecastService {
     ...
     * прогнозов указаны по часовому поясу данного места), или null, если место не найдено
     *
     * @param placeName название места
     * @param daysCount количество дней
     * @return список прогнозов погоды по часам для указанного числа дней, или null, если место не найдено
     */
